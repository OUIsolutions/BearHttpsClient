...
To install the lib just copy the [Amalgamation](https://github.com/OUIsolutions/BearHttpsClient/releases/download/0.2.000/BearHttpsClientOne.c) into your project and include it in your code:
```c
...
```bash
curl -L https://github.com/OUIsolutions/BearHttpsClient/releases/download/0.2.000/BearHttpsClientOne.c -o BearHttpsClientOne.c
```
